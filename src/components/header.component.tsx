  ...
  return (
    <div className="overflow-y-hidden relative">
      <div className="flex flex-col gap-8 md:gap-16 bg-white dark:bg-gray-800 transition delay-300 duration-500 p-5 md:p-20 ">
        ...
        {ShowDescription && (
          <p className="p-5 text-2xl md:text-4xl text-center md:text-justify font-[SourceCodePro] text-gray-500 dark:text-gray-100 transition delay-300 duration-500 break-words">
            {Description}
          </p>
        )}
      </div>
