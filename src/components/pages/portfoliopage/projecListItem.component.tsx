...
type ProjectListItemPropType = { ProjectID: number } & ProjectType;
...
function ProjectListItem(projectItem: ProjectListItemPropType) {
  ...
  return (
    <Link to="/project" onClick={setCurrentProjectItem}>
      <Card className="flex flex-row flex-wrap gap-4 px-7 pb-5 pt-8 bg-white dark:bg-gray-800 justify-center 2xs:justify-normal transition delay-300 duration-500 hover:scale-[1.02]">
